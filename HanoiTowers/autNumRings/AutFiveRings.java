...
public class AutFiveRings {
    public static void autFiveR(){
        int ourRingWhoGo;
        int choose = 0;
        int a;
        long counter = 0;
        ...
        while (choose != 2){
            ...
            switch (gamePlay) {
                case 1:
                    if (ourArray[0][0] == 0 && ourArray[1][0] == 0 && ourArray[2][0] == 0 && ourArray[3][0] == 0 && ourArray[4][0] == 0 && ourArray[5][0] == 0) {
                    ...
                    switch (chooseOneWhatRingTo) { //Сам ход: перенос колец на выбран. место
                        case 1:
                            ...
                            while (ourArray[a][1] == 0) {//!!!!Начало кода для определения какое кольцо на столбе переносится
                                if (ourArray[a][1] == 1 || ourArray[a][1] == 2 || ourArray[a][1] == 3 || ourArray[a][1] == 4 ||  ourArray[a][1] == 5) {
                                    break;
                                }
                                if (a == 4) {
                                    break;
                        ...
                        case 2:
                            ...
                            while (ourArray[a][2] == 0) {//!!!!Начало кода для определения какое кольцо на стержне переносится
                                if (ourArray[a][2] == 1 || ourArray[a][2] == 2 || ourArray[a][2] == 3 || ourArray[a][2] == 4 ||  ourArray[a][2] == 5) {
                                    break;
                                }
                                if (a == 4) {
                                    break;
                ...
                case 2: //Начало кода для второго стержня
                    if (ourArray[0][1] == 0 && ourArray[1][1] == 0 && ourArray[2][1] == 0 && ourArray[3][1] == 0 && ourArray[4][1] == 0) {
                ...
                case 3:  //Начало для третьего стержня
                    if (ourArray[0][2] == 0 && ourArray[1][2] == 0 && ourArray[2][2] == 0 && ourArray[3][2] == 0 && ourArray[4][2] == 0) {
            ...
            for (int i = 0; i <= 4; i++) {    //Начало кода для вывода экрана для игрока после хода
                watchArray = "";
                for (int j = 0; j <= 2; j++) {
                    if (ourArray[i][j] == 0) {
                        watchArray = watchArray + "* ";
            ...
            System.out.println();
            if (ourArray[0][2] == 1 && ourArray[1][2] == 2 && ourArray[2][2] == 3 && ourArray[3][2] == 4 && ourArray[4][2] == 5){
