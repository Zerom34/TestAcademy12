...
public class AutSixRings {
    public static void autSixR(){
        ...
        while (choose != 2){
            ...
            for (int i = 0; i <= 5; i++) { //Начало кода для вывода экрана игры для игрока до хода
                watchArray = "";
                for (int j = 0; j <= 2; j++) {
                    if (ourArray[i][j] == 0) {
            ...
            switch (gamePlay) {
                        ...
                        case 1:
                            ...
                            while (ourArray[a][1] == 0) {//!!!!Начало кода для определения какое кольцо на столбе переносится
                                if (ourArray[a][1] == 1 || ourArray[a][1] == 2 || ourArray[a][1] == 3
                                        || ourArray[a][1] == 4 ||  ourArray[a][1] == 5 ||  ourArray[a][1] == 6) {
                                    break;
                                }
                                if (a == 5) {
                                    break;
                        ...
                        case 2:
                            ...
                            while (ourArray[a][2] == 0) {//!!!!Начало кода для определения какое кольцо на стержне переносится
                                if (ourArray[a][2] == 1 || ourArray[a][2] == 2 || ourArray[a][2] == 3
                                        || ourArray[a][2] == 4 || ourArray[a][2] == 5 ||  ourArray[a][2] == 6) {
                                    break;
                                }
                                if (a == 5) {
                                    break;
                ...
                case 2: //Начало кода для второго стержня
                    if (ourArray[0][1] == 0 && ourArray[1][1] == 0 && ourArray[2][1] == 0
                            && ourArray[3][1] == 0 && ourArray[4][1] == 0 && ourArray[5][1] == 0) {
                        ...
                        case 1:
                            ...
                            while (ourArray[a][0] == 0) {//!!!!Начало кода для определения какое кольцо на столбе переносится
                                if (ourArray[a][0] == 1 || ourArray[a][0] == 2 || ourArray[a][0] == 3
                                        || ourArray[a][0] == 4 || ourArray[a][0] == 5 || ourArray[a][0] == 6) {
                                    break;
                                }
                                if (a == 5) {
                                    break;
                ...
                case 3:  //Начало для третьего стержня
                    if (ourArray[0][2] == 0 && ourArray[1][2] == 0 && ourArray[2][2] == 0
                            && ourArray[3][2] == 0 && ourArray[4][2] == 0 && ourArray[5][2] == 0) {
            ...
            for (int i = 0; i <= 5; i++) {    //Начало кода для вывода экрана для игрока после хода
                watchArray = "";
                for (int j = 0; j <= 2; j++) {
                    if (ourArray[i][j] == 0) {
                        watchArray = watchArray + "* ";
            ...
            if (ourArray[0][2] == 1 && ourArray[1][2] == 2 && ourArray[2][2] == 3
                    && ourArray[3][2] == 4 && ourArray[4][2] == 5 && ourArray[5][2] == 6){
