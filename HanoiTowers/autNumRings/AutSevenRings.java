...
public class AutSevenRings {
    public static void autSevenR() {
        int ourRingWhoGo;
        int choose = 0;
        int a;
        int counter = 0;
        ...
        while (choose != 2){
            ...
            for (int i = 0; i <= 6; i++) { //Начало кода для вывода экрана игры для игрока до хода
                watchArray = "";
                for (int j = 0; j <= 2; j++) {
                    if (ourArray[i][j] == 0) {
            ...
            switch (gamePlay) {
                ...
                case 2: //Начало кода для второго стержня
                    if (ourArray[0][1] == 0 && ourArray[1][1] == 0 && ourArray[2][1] == 0
                            && ourArray[3][1] == 0 && ourArray[4][1] == 0 && ourArray[5][1] == 0 && ourArray[6][1] == 0) {
            ...
            for (int i = 0; i <= 6; i++) {    //Начало кода для вывода экрана для игрока после хода
                watchArray = "";
                for (int j = 0; j <= 2; j++) {
                    if (ourArray[i][j] == 0) {
                        watchArray = watchArray + "* ";
            ...
            if (ourArray[0][2] == 1 && ourArray[1][2] == 2 && ourArray[2][2] == 3
                    && ourArray[3][2] == 4 && ourArray[4][2] == 5 && ourArray[5][2] == 6 && ourArray[6][2] == 7){
